...
l = int(input("enter the number for which action you want to perform on the tree: 1 for traversal, 2 for insertion, 3 for deletion, and 4 for searching: "))
if l == 1:
    inOrderTrav(root)
elif l == 2:
    ...
    print("please try again with a a valid value")